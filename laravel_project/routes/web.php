...
Route::middleware('auth')->group(function () {
    ...
    // Route::get('/categories', [CategoryController::class, 'index'])->name('categroy.all');
    // Route::get('/category/new', [CategoryController::class, 'create'])->name('category.new');
    // Route::get('/category/edit/{id}', [CategoryController::class, 'edit'])->name('category.edit');
    // Route::post('/category/delete/{id}', [CategoryController::class, 'destory'])->name('category.edit');
...
Route::middleware('auth:admin')->prefix('admin')->group( function () {
    ...
    Route::view('/dashboard','backend.admin_dashboard');
                //path admin_dashboard          //file bacdend.admin_dashboard
});
...
Route::middleware('auth:manager')->prefix('manager')->group( function () {
    ...
    Route::post('logout', [App\Http\Controllers\Auth\Admin\LoginController::class, 'destroy'])->name('manager.logout');
